       ...
       {/* image */}
        <div className="relative aspect-square overflow-hidden">
          ...
          <div className="absolute top-2.5 left-3 flex flex-wrap gap-1.5 ">
            {product.discount > 0 &&
              <span className="px-3 py-2 text-[10px] font-semibold uppercase bg-app-orange text-white rounded-full">
          ...
          <div className="p-3.5 text-zinc-700">
             <h3 className="text-sm leading-sung mb-1.5 line-clamp-2">{product.name}</h3>
             ...
             {product.rating > 0 && (
                <div className="flex items-center gap-1 mb-2 ">
                   ...
                   <span className="text-xs text-app-text text-light">({product.reviewCount})</span>
                </div>
             )}
                   {/* price + add */}
               <div className="flex items-center justify-between">
                ...
                <button onClick={(e)=>{e.stopPropagation(); addToCart(product)}} className="bg-app-orange rounded-full text-white size-7 flex-center shrink-0 hover:bg-app-orange-dark  transition-colors active:scale-95">
